...
/** Test-only v7-B client for the pre-registered request-overhead reduction package. */
final class OllamaLocalShadowOverheadReductionDiagnosticClient
    implements OllamaTruncationDiagnosticApi {
  ...
  public OllamaTruncationDiagnosticResult diagnose(
    ...
    request.set("format", formatSchema(selectionSchema));
  ...
  private ObjectNode formatSchema(ObjectNode fullSelectionSchema) {
    ObjectNode formatSchema = fullSelectionSchema.deepCopy();
